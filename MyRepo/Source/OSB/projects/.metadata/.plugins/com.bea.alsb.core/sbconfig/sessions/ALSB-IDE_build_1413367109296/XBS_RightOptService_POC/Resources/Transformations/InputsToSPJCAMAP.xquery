...
xf:InputsToSPJCAMAP($inputs1)</con:xquery>
    <con:dependency location="../XSD/XBSRightOptInputs.xsd">
        <con:schema ref="XBS_RightOptService_POC/Resources/XSD/XBSRightOptInputs"/>
    </con:dependency>
    <con:dependency location="../JCABinding/XRXService/xsd/getResults_sp.xsd">
        <con:schema ref="XBS_RightOptService_POC/Resources/JCABinding/XRXService/xsd/getResults_sp"/>
    </con:dependency>
</con:xqueryEntry>