...
declare namespace xf = "http://tempuri.org/RightOpt_GenericBS_MultipleOperations/Resources/Transformations/ReqXML_to_ACS/";
...
declare function xf:ReqXML_to_ACS($ReqXML as element(ns0:Inputs),
    ...
    as element(ns1:InputParameters) {
        <ns1:InputParameters>
            ...
            <ns1:SSN_NR>{$ReqXML/ns0:Arg[@name=$get_properties/row/SSN_NR/text()]/text()}</ns1:SSN_NR>
       </ns1:InputParameters>
};
...
xf:ReqXML_to_ACS($ReqXML,
    ...
    <con:dependency location="../Schemas/RightOpt_ACS_sp.xsd">
        <con:schema ref="RightOpt_GenericBS_MultipleOperations/Resources/Schemas/RightOpt_ACS_sp"/>
    </con:dependency>
</con:xqueryEntry>