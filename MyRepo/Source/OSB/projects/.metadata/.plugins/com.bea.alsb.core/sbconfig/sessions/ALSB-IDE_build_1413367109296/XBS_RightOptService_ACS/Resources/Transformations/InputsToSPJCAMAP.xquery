...
(:: pragma bea:global-element-return element="ns1:InputParameters" location="../JCABinding/ACSRightOptService/xsd/getResults_sp.xsd" ::)
...
xf:InputsToSPJCAMAP($inputs1)</con:xquery>
    <con:dependency location="../XSD/XBSRightOptInputs.xsd">
        <con:schema ref="XBS_RightOptService_ACS/Resources/XSD/XBSRightOptInputs"/>
    </con:dependency>
    <con:dependency location="../JCABinding/ACSRightOptService/xsd/getResults_sp.xsd">
        <con:schema ref="XBS_RightOptService_ACS/Resources/JCABinding/ACSRightOptService/xsd/getResults_sp"/>
    </con:dependency>
</con:xqueryEntry>