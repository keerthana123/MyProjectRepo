...
declare namespace xf = "http://tempuri.org/XBS_RightOpt_Service/Resources/Properties/ResultSet_to_XRXxml/";
declare namespace daws = "http://ivr.acshrsolutions.com/DAWS";

declare function xf:ResultSet_to_XRXxml($ErrMsg as xs:string)
...
xf:ResultSet_to_XRXxml($ErrMsg)]]></con:xquery>
